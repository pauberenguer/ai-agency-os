---
description: Tour interactivo de 5 días que te enseña a usar AI Agency OS desde cero. Idempotente — retoma donde lo dejaste.
---

# /aprende — Tour de 5 días por AI Agency OS
...
AI Agency OS viene con **27 skills core** preinstaladas, pero el ecosistema Claude tiene cientos más. Hay tres formas de añadir cosas:
...
2. **Investigación del cliente** → la búsqueda web nativa de Claude enriquece con datos públicos (web, LinkedIn, BORME si España…)
