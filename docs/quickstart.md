# Quickstart — primeros 30 minutos con AI Agency OS
...
Antes de publicar: `Ejecuta tool-seguridad-ia y tool-web-security-audit`.
...
Primero: `Usa arnes para arrancar el proyecto con el nivel adecuado`.
...
Para una búsqueda ligera usa la búsqueda web nativa; para un informe serio, `strategy-investigacion-profunda`.
