...
de autonomía. Es el meta-loop del sistema y encaja con el ritual semanal H2 de `protocolo-sesion`.
...
2 · DISPARADOR
   ...
   [x] Programado: viernes vía tarea programada de Claude Desktop; encaja con el ritual semanal H2 de `protocolo-sesion` [PERSONALIZA: hora]
...
9 · MÉTRICAS Y APRENDIZAJE
   ...
   Revisión: semanal, 15 min — viernes dentro del H2 de `protocolo-sesion` [PERSONALIZA: hora]
```
