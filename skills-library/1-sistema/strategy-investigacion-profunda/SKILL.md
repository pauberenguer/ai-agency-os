...
**Cuándo usarla:** para búsqueda ligera y rápida basta la búsqueda web nativa de Claude. `strategy-investigacion-profunda` se usa cuando hace falta informe completo con triangulación, scoring de fuentes, evidencias persistidas y verificación de afirmaciones.
...
Skill original de Pau Berenguer (AI Agency Accelerator), adaptada para ai-agency-os.
