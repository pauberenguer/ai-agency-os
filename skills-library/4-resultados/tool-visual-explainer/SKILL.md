...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .metric-card .value { font-size: 24px; font-weight: bold; color: #0a0a0a; }
    pre, code {
...
<body>
  <div class="container">
    ...
    <footer>
      Generado por AI Agency OS · <a href="https://aiagencyaccelerator.com">aiagencyaccelerator.com</a>
    </footer>
  </div>
</body>
</html>
...
- **Usuario quiere paleta distinta a la monocroma AI Agency**: aceptar override en input (`brand_color: "#XYZ"`). Default mantiene paleta del OS.
...
- **Paleta AI Agency**: negro `#0a0a0a` (acento y texto), gris `#6b6b6b` (secundario/citas), gris claro `#f4f4f4` (superficies), blanco `#ffffff` (fondo). Minimalista, coherente con la web del programa.
