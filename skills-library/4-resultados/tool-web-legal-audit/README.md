...
```bash
git clone https://github.com/pauberenguer/web-legal-audit.git ~/.claude/skills/web-legal-audit
```
...
Creado por **Pau Berenguer** · **AI Agency Accelerator** / Pau Berenguer
· `hola@aiagencyaccelerator.com` ·
