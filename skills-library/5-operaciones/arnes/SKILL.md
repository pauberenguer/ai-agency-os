---
name: arnes
description: Skill opt-in para arrancar proyectos de software paso a paso, pensada para vibe-coders no tecnicos de AI Agency Accelerator. Tres niveles segun lo serio que sea el proyecto (Express 5 min / Estandar 20-30 min / PRO 1-2 h) mas dos modos para proyectos existentes (Adoptar / Mantener). SIEMPRE pregunta primero que nivel quieres porque la mayoria de veces basta con Express. ACTIVAR cuando el usuario diga «nuevo proyecto», «crear una app», «monta una web», «landing», «arrancar proyecto», «adopta este proyecto», «renueva este proyecto», o describa la idea de un software/web/app que quiere construir. Esta skill vive vendoreada en `vendor/arnes/` y se activa con `/install-skill arnes`.
version: 0.2.4
---

# arnes (vendored wrapper)

> **Origen del concepto**: `fs-scaffold` por Fernando Montero (Fersora Solutions SL).
> **Adaptacion a vibe-coders**: Pau Berenguer (AI Agency Accelerator).
> **Repo upstream**: [github.com/pauberenguer/arnes](https://github.com/pauberenguer/arnes) (publico, MIT).
...
Para alguien que abre AI Agency OS por primera vez, arrancar proyectos software puede no ser su prioridad inmediata. Quien quiere arnes lo sabe; quien no lo necesita no se topa con ruido conceptual. Mismo criterio que el resto de skills opt-in de la biblioteca.

## Creditos

Basada en el concepto original **fs-scaffold** de **Fernando Montero** (Fersora Solutions SL). La skill arnes adapta ese concepto para vibe-coders no tecnicos manteniendo el rigor donde importa.
...
La skill se mantiene en su repo upstream [`pauberenguer/arnes`](https://github.com/pauberenguer/arnes). Cuando saca nueva version, se actualiza `vendor/arnes/` mediante el flujo de "Mantener" de arnes o un PR a ai-agency-os. Reportar bugs en: https://github.com/pauberenguer/arnes/issues
